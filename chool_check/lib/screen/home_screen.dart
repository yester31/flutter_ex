...
class HomeScreen extends StatelessWidget {
  static final LatLng companyLatLng = LatLng(37.3701431, 127.1116954);
  //static final LatLng companyLatLng = LatLng(37.3801431, 127.1116954);
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          showDialog(
                            ...
                            builder: (_) {
                              return AlertDialog(
                                title: const Text('출첵하기'),
                                content: Text(canCheck ? '출첵?' : '출첵할 수 없습니다.'),
                                actions: [
                                  TextButton(
                                    onPressed: () {
  ...
  Future<String> checkPermission() async {
    ...
    if (checkedPermission == LocationPermission.deniedForever) {
      return '위치 권한이 영구적으로 거부되었습니다. 설정에서 위치 권한을 허용해주세요.';
    }
